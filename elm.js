...
var _debois$elm_mdl$Main$defaultModel = {name: '', mdl: _debois$elm_mdl$Material$model};
var _debois$elm_mdl$Main$Model = F2(
	function (a, b) {
		return {name: a, mdl: b};
	});
var _debois$elm_mdl$Main$Name = {ctor: 'Name'};
var _debois$elm_mdl$Main$OnChange = F2(
	function (a, b) {
		return {ctor: 'OnChange', _0: a, _1: b};
	});
var _debois$elm_mdl$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _debois$elm_mdl$Main$viewForm = F2(
	function (mdl, model) {
		return A5(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Textfield$label('Input'),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _debois$elm_mdl$Material_Options$onInput(
								_debois$elm_mdl$Main$OnChange(_debois$elm_mdl$Main$Name)),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Textfield$value(model.name),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _debois$elm_mdl$Main$dialog = F2(
	function (mdl, model) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_debois$elm_mdl$Main$viewForm, mdl, model),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _debois$elm_mdl$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'OnChange') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{ctor: '[]'});
		} else {
			return A3(_debois$elm_mdl$Material$update, _debois$elm_mdl$Main$Mdl, _p0._0, model);
		}
	});
var _debois$elm_mdl$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Main$dialog, model.mdl, model),
				_1: {ctor: '[]'}
			}
		});
};
var _debois$elm_mdl$Main$main = _elm_lang$html$Html$program(
	{
